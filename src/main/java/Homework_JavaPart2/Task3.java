...
public class Task3 {
    ...
    public static void main(String[] args) {
        ...
        int givenNumber = 50;
        boolean containsGivenNumber = containsGivenNumber(numberCollection, givenNumber);
    ...
    public static void removeEvenNumbers(ArrayList<Integer> collection) {
        collection.removeIf(number -> number % 2 == 0);
    }

    public static boolean containsGivenNumber(ArrayList<Integer> collection, int givenNumber) {
        return collection.contains(givenNumber);
    }
}
